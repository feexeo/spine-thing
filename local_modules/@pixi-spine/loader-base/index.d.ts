 ...
 * @public
 */
export declare const makeSpineTextureAtlasLoaderFunctionFromPixiLoaderObject: (loader: Loader, atlasBasePath: string, imageMetadata: any, imageURL?: string) => (pageName: string, textureLoadedCallback: (tex: BaseTexture) => any) => Promise<void>;
